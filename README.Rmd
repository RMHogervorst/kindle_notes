---
title: "Turning kindle notes into a data.frame"
...
It is my dream to do everything with R. And we aRe LEKKER ONDERWEG.
...
webpages with shiny (thank you [Winston Chang](https://twitter.com/winston_chang))
...
[tidyverse](http://tidyverse.org/), I found something that wasn't tidy. `r emo::ji("disappointed")` 
...
I first create a data_frame^[1] and pre-populate it.
...
## Notes
[1]: I use the tidyverse form called tibble or data_frame, it is like a data.frame but it never converts character to factor and never adds rownames . See more at `?tibble::tibble`.
 
[2]: Sometimes loops are slow when R doesn't know
